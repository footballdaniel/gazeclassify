...
class ResultAnalysis:
    ...
    def __init__(self, filepath: str): 
        ...
        self.df3 = self.dfHJdrop.groupby(['joint'], as_index=False, dropna = False).agg(n = pd.NamedAgg(column='joint', aggfunc='count'),)
    ...
    def barplot(self):
        ...
        self.ax.barh(self.Results.joint, self.Results.Percentages, align='center',color="cyan",orientation="horizontal")
    ...
    def timeseries_human_shape(self):
    ...
    def timeseries_plot(self, joint: str):
